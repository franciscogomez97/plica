...
@section('content')
    ...
    <section class="py-8 text-center sm:py-14">
        ...
        <p class="mt-4 text-sm text-slate-500">Gratis hasta el {{ $gratisHasta->isoFormat('D [de] MMMM [de] YYYY') }}. Te lo montamos nosotros y te atendemos por WhatsApp, sin reuniones.</p>
        @if ($whatsapp)
