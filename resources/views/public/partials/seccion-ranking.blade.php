        ...
        <div class="mt-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
            ...
            @if ($texto)
                <div class="flex flex-wrap items-center gap-2">
                    @include('partials.compartir', ['titulo' => 'Ranking '.$seccion->nombre.' · '.$club->nombre, 'texto' => $texto, 'url' => $url, 'imagen' => \App\Services\Podio::urlRanking($temporada, $seccion, $grupo), 'compacto' => true])
                    @if ($enPanel)
