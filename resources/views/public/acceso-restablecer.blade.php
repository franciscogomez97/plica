    ...
    <div class="mx-auto max-w-md">
        <div class="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            ...
            <p class="mt-2 text-base text-slate-400">
                ...
                <span class="font-medium text-slate-200">{{ $socio->club->nombre }}</span> y entrarás directamente.
            </p>

            <form method="POST" action="{{ route('acceso.claim', $token) }}" class="mt-6 space-y-4">
                @csrf
                <div>
                    <label class="mb-1.5 block text-base font-medium text-slate-200" for="password">Contraseña nueva</label>
                    <div class="relative">
