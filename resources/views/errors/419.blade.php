...
@section('content')
    <div class="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-6 text-center">
        ...
        <p class="mt-3 text-base text-slate-500">Llevaba demasiado tiempo abierta y el formulario ha caducado. Vuelve atrás y repítelo; no se ha guardado nada a medias.</p>
        <a href="javascript:history.back()" class="mt-6 inline-block w-full rounded-xl bg-emerald-700 py-3.5 text-base font-semibold text-white hover:bg-emerald-700">Volver atrás</a>
        @auth
