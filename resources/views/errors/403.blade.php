...
@section('content')
    <div class="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-6 text-center">
        ...
        <p class="mt-3 text-base text-slate-500">Esta página es de otro club o necesita una cuenta con más permisos. Si crees que es un error, habla con el admin de tu club.</p>
